...
export const OtherPacificIslander = 'OtherPacificIslander'
...
Dimension2Text[OtherPacificIslander] = 'Other Pacific Islander'
...
// Major Occupations
export const SOCLifeScientistsOccupation = 'SOCLifeScientistsOccupation'
...
export const SOCSocialScientistsRelatedWorkersOccupation =
...
export const SOCLifePhysicalSocialScienceOccupation = 'SOCLifePhysicalSocialScienceOccupation'
export const SOCMathematicalScienceOccupation = 'SOCMathematicalScienceOccupation'
export const SOCPsychologistsOccupation = 'SOCPsychologistsOccupation'
Dimension2Text[SOCLifeScientistsOccupation] = 'Biological, agricultural, and other life scientists'
Dimension2Text[SOCComputerMathematicalOccupation] = 'Computer and mathematical scientists'
Dimension2Text[SOCPhysicalScientistsOccupation] = 'Physical and related scientists'
Dimension2Text[SOCSocialScientistsRelatedWorkersOccupation] = 'Social and related scientists'
Dimension2Text[SOCEngineersOccupation] = 'Engineers'
Dimension2Text[ScienceAndEngineeringRelatedOccupation] = 'S&E-related occupations'
Dimension2Text[NonScienceAndEngineeringOccupation] = 'Non-S&E occupations'
Dimension2Text[ScienceAndEngineeringOccupation] = 'S&E occupations'
Dimension2Text[SOCLifePhysicalSocialScienceOccupation] = 'Life, Physical, and Social scientists'
Dimension2Text[SOCMathematicalScienceOccupation] = 'Mathematicians'
Dimension2Text[SOCPsychologistsOccupation] = 'Psychologists'
...
export const Tenured = 'Tenured'
export const NotOnTenureTrack = 'NotOnTenureTrack'
export const OnTenureTrack = 'OnTenureTrack'
export const TenureNotApplicable = 'TenureNotApplicable'

Dimension2Text[Tenured] = 'Tenured'
Dimension2Text[NotOnTenureTrack] = 'Not on Tenure track'
Dimension2Text[OnTenureTrack] = 'On Tenure track'
Dimension2Text[TenureNotApplicable] = 'Tenure N/A'
