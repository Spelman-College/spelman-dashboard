...
describe('demo query', () => {
    ...
    test('test 2 ethnicities', () => {
        ...
        expect(out.results).toEqual(["Count_Person_EducationalAttainmentBachelorsDegreeOrHigher_Employed_Asian",
    ...
    test('test 2 occupations', () => {
        ...
        expect(out.error).toEqual(undefined)
        expect(out.results).toEqual(["Count_Person_EducationalAttainmentBachelorsDegreeOrHigher_Employed_SOCLifeScientistsOccupation",
    ...
    test('test each occupation', () => {
        all_occupations.forEach((occupation) => {
            ...
            expect(out.results).toEqual(["Count_Person_EducationalAttainmentBachelorsDegreeOrHigher_Employed_".concat(occupation)])
        })
    })
    test('test each ethnicity', () => {
        all_ethnicities.forEach((ethnicity) => {
            ...
            let out = demo.query(query)
            expect(out.results).toEqual(["Count_Person_EducationalAttainmentBachelorsDegreeOrHigher_Employed_".concat(ethnicity)])
        })
    })
    test('test each gender', () => {
        all_genders.forEach((gender) => {
            ...
            let out = demo.query(query)
            expect(out.results).toEqual(["Count_Person_EducationalAttainmentBachelorsDegreeOrHigher_Employed_".concat(gender)])
        })
    })
})
